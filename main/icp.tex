...
Показано практичні результати застосування ітеративного алгоритму найближчих
...
Нехай $\tilde{\pmb{s}} = \pmb{s} - \overline{\pmb{s}}, \,
...
\end{equation*}
Згадаємо, що $ \Sigma $ ---
діагональна матриця з додатними елементами
\begin{equation*}
...
\end{equation*}
Використаємо нерівність Мінковського \cite{DorogovtsevMA}.
...
Множину $S$, яка складається з точок $\pmb{s} = R \cdot \pmb{t} + \pmb{b}$,
зображено суцільною лінією, де $\pmb{t}$~---~точки множини $T$,
а матриця повороту
\begin{equation*}
  R =
  \begin{bmatrix}
...
Для цього прикладу була використана тривимірна модель,
що складається з $2503$ точок, створена Грегом Тюрком та Марком Левоєм в
Стенфордському університеті в 1994 році для тестування алгоритмів.
Точки вихідної множини повернули навколо осі $z$ на $3$ градуси та зсунули на
$0.1$ в бік, протилежний спостерігачеві.
Матриця повороту має вигляд
\begin{equation*}
  R = \begin{bmatrix}
...
До точок вихідної множини також доданий ґаусів шум з математичним сподіванням
$0$ та дисперсією $0.01^2$.
Вихідна та отримана множини зображені на рисунку \ref{fig:bunny:input}.
...
точок, алгоритм відпрацював добре.
Результат співставлення зображений на рисунку \ref{fig:bunny:result}.
...
Оцінка матриці повороту має вигляд
\begin{equation*}
  R = \begin{bmatrix}
  0.99964516  & 0.02658041  & -0.00174453 \\
  -0.02656692 & 0.99962006  & 0.0073438 \\
  0.00193907  & -0.00729485 & 0.99997151
  \end{bmatrix},
\end{equation*}
а оцінка вектора зсуву
$\pmb{b} = \left( 0.0024873, 0.00142,  0.10096224 \right)^T$.
Отримані значення досить близькі до справжніх.

Такого результату вдалося досягти за $2$ хвилили $43$ секунди на компьютері з
процесором Intel Core i5-3317U, виконавши $10$ тисяч ітерацій.
Програмне забезпечення будо написано на Pyhton $2.7$ спеціально для цієї роботи.
За більшого кута повороту або більшій дисперсії шуму шукані параметри
відновлюються не так точно.

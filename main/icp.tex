...
Це те ж саме, що шукати такий набір
...
Тому метод найменших квадратів без обмежень не підходить.
...
\begin{enumerate}
  ...
  \item коли $ \det{R} = \det{ \left( V \cdot U^T \right) } = -1$,
  тобто матриця $R$ діє як поворот і дзеркальне відображення відносно площини
  екрану.
\end{enumerate}
...
\subsection{Розподіл елементів матриці повороту}

...
На наступному кроці виконується пошук повороту $R$ та зсуву $ \pmb{b}$
...
\begin{align*}
  ...
  \end{array} \right.
\end{align*}
Таким чином, для кожної точки $ \pmb{s} \in S$ знаходимо точку
$ \pmb{t}^* \in T$ таку,
щоб відстані між парами $R \cdot \pmb{s} + \pmb{b}$ та $ \pmb{t}^*$ для всіх
$ \pmb{s} \in S$ були найменшими
\begin{equation*}
  \left \Vert R \cdot \pmb{s} + \pmb{b} - \pmb{t}^* \right \Vert^2 =
  \min \limits_{\pmb{t} \in T}
    \left \Vert R \pmb{s} + \pmb{b} - \pmb{t} \right \Vert^2.
\end{equation*}
Якщо для якоїсь точки $\pmb{s}$ знайдено декілька таких точок $\pmb{t}^*$,
то вибираємо будь-яку.

\subsection{Пошук перетворення за допомогою методу найменших квадратів}

За поточною розміткою $k$ шукаємо поворот $R$ та зсув $ \pmb{b}$
\eqref{eq:second:iteration}.
При цьому матриця $R \in SO \left( 3 \right) $,
тобто ортогональна матриця розмірності $3 \times 3$ з визначником $+1$.

Розглянемо застосування методу найменших квадратів без обмежень на матрицю $R$
на прикладі (рис. \ref{fig:triangles:least:squares}).

\begin{figure}[h]
  \centering
  \includestandalone[mode=buildnew]{../tikz/triangles_least_squares}
  \caption{Приклад, який показує незадовільність методу найменших квадратів}
  \label{fig:triangles:least:squares}
\end{figure}

Трикутник, зображений пунктиром, є вихідною множиною $S$,
а його вершини мають координати
$ \left( -1, 0 \right), \, \left( -1, 1 \right) $ та $\left( 0, 0 \right)$.
Трикутник, зображений суцільною лінією, є цільовою множиною $T$,
яка отримана з $S$ зміщенням на $1$ вправо та поворотом на $180$ градусів.
Вершини цього трикутника мають координати
$ \left( 0, 0 \right), \, \left( 1, 0 \right)$ та $\left( 1, -1 \right)$.

Перший крок ітеративного алгоритму дає таку розмітку, що всім точкам множини
$S$ відповідає точка $\left( 0, 0 \right)$ множини $T$.
Оцінимо поворот на зсув методом найменших квадратів,
який описаний в попередньому розділі.
...
\begin{equation*}
  ...
  \end{bmatrix}.
\end{equation*}
Всі визначники, окрім $\Delta = 1$, дорівнюють нулю,
тому маємо такі оцінки шуканих параметрів
\begin{equation*}
  \pmb{b} =
  \begin{bmatrix}
    0 \\
  ...
  \end{bmatrix}.
\end{equation*}
Отримана матриця не є матрицею повороту, адже її визначник дорівнює нулю.
Знайдене перетворення множини $S$ таке,
що всі її точки тепер знаходяться в координаті $\left( 0, 0 \right) $.
На цьому алгоритм зупиняється, бо функція \eqref{eq:least:squares}
дорівнює нулю та більше не може зменшуватись.
...
взявши градієнт від $E$ по $ \pmb{b}$ та прирівнявши його до нуля
\begin{equation}\label{eq:derivative}
  0 =
  \nabla E \left( \pmb{b} \right) =
  \sum \limits_{\pmb{s} \in S}
...
\end{equation}
Знайшли оптимальний вектор $ \pmb{b}$,
...
\begin{equation*}
  ...
  \end{gathered}
\end{equation*}
Таким чином, в задачі мінімізації позбулися невідомого вектора $\pmb{b}$,
...
$3 \times 3$, а $ \tilde{\pmb{k_s}}$ має розмірність $3 \times 1$.
...
відкинувши суми $ \tilde{\pmb{s}}^T \cdot \tilde{\pmb{s}}$ та
...
що максимізація виразу еквівалентна його мінімізації за знаком <<мінус>>
\begin{equation*}
   R =
...
\end{equation*}
де $P$~---~многочлен.
Покажемо, що ймовірність того, що визначник майже напевно не дорівнює нулю,
дорівнює нулю.
...
\end{equation*}
Матриці $V, \, R$ и $U$~---~ортогональні, а тому матриця
\begin{equation*}
  M =
  V^T \cdot R \cdot U
\end{equation*}
...
\end{equation*}
За означенням сингулярного розкладу $ \Sigma $ ---
...
\begin{enumerate}
  ...
  \item кроки повторюються один за одним,

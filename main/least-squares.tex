...
Відомо, що $M\pmb{k}_x = A \cdot \pmb{\theta}$.
Отже,
$M \hat{\pmb{\theta}} =
...
В класі оцінок $\pmb{\theta}^*$ величини $\pmb{\theta}$, які
\begin{enumerate}
...
Іншими словами,
$\hat{\pmb{\theta}}$ є оптимальною оцінкою $\pmb{\theta}$ з усіх можливих,
...
\begin{equation*}
  ...
  \pmb{\theta}.
\end{equation*}
Остання рівність виконується для всіх $\pmb{\theta}$, тому
\begin{equation*}
  U \cdot A = I.
\end{equation*}

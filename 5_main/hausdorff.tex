...
\begin{enumerate}
  ...
  \begin{gather*}
    ...
    = inf \left\{
      \varepsilon_1 > 0 \, : \qquad E + \varepsilon_1 \subset F, \, F + \varepsilon_1 \subset E
    \right\} + \\
    + inf \left\{
      \varepsilon_2 > 0 \, : \qquad F + \varepsilon_2 \subset G, \, G + \varepsilon_2 \subset F
    \right\}.
  \end{gather*}
...
\begin{enumerate}
  ...
  \begin{equation*}
    ...
    \left\{ \omega \, : \qquad \xi \left( \omega \right) \in \Delta \right\} \in \mathcal{F};
  \end{equation*}
  \item функция $ \xi \, : \, \Omega \to \mathbb{R}$ называется случайной величиной, если
  \begin{equation*}
    \forall c \in \mathbb{R} \, : \qquad
    \left\{ \omega \, : \qquad \xi \left( \omega \right) \leq c \right\} =
...
\begin{equation*}
  \forall c \in \mathbb{R}: \qquad
  \left\{ \omega \, : \qquad \inf \limits_n \varepsilon_n \left( \omega \right) \leq c \right\} =
  \bigcup \limits_{n = 1}^{ \infty }
    \left\{ \omega \, : \qquad \varepsilon_n \left( \omega \right) \leq c \right\}.
\end{equation*}

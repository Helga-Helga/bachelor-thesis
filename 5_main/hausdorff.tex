...
\begin{enumerate}
  ...
  то есть $d \left( y_{ \varepsilon }, x \right) < \varepsilon $.
  Это выполнено при любом $ \varepsilon > 0$, следовательно,
  ...
  что $x \in E$ и $G + \varepsilon_{E, G} \subset E$, следует что $x \in G$.
  Аналогично, для второй стоки получаем, что из того,
  что $x \in G$ и $F + \varepsilon_{G, F} \subset G$ следует, что $x \in F$.
  Таким образом, получаем цепочку включённых друг в друга множеств
  \begin{equation*}
    x \in
    E \subset
    G + \varepsilon_{E, G} \subset
    G \subset
    F + \varepsilon_{G, F} \subset
    F + \varepsilon_{G, F} + \varepsilon_{E, G},
  \end{equation*}
  что и нужно было показать, то есть неравенство треугольника справделиво.
\end{enumerate}
